...
| D4 | `npm run verify` gate added (`scripts/verify.js`, `scripts/package-policy.js`, dependency audit, double-build determinism, repository-cleanliness check) | No runtime behaviour change. Blocks packaging when the tree is dirty or policy fails. | 苏白, 2026-08-03 | `ae85d6b`, `651481e`, `9b5eebd` | authorized |
