/**
 * YOS Web Console - Frontend Application with WebSocket
 */
...
class YOSConsole {
  ...
  showEmptyState() {
    ...
    empty.innerHTML = `
      <div class="empty-avatar"><img src="logo.png" alt="YOS"></div>
      <h2>Welcome to YOS</h2>
  ...
  try {
    ...
    loginForm.addEventListener('submit', async (e) => {
      ...
      if (result.success) {
        ...
        new YOSConsole(result.timezone);
      } else {
