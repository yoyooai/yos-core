...
Usage: ~/yos/.claude/skills/scheduler/scripts/cli.js <command> [options]
...
Examples:
  ~/yos/.claude/skills/scheduler/scripts/cli.js add "Say hello" --in "30 minutes"
  ~/yos/.claude/skills/scheduler/scripts/cli.js add "Health check" --cron "0 8 * * *"
  ~/yos/.claude/skills/scheduler/scripts/cli.js add "Check updates" --every "1 hour"
  ~/yos/.claude/skills/scheduler/scripts/cli.js update task-abc --priority 1
  ~/yos/.claude/skills/scheduler/scripts/cli.js update task-abc --block-queue-until-idle
  ~/yos/.claude/skills/scheduler/scripts/cli.js done task-abc123
`;
