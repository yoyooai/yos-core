 ...
 *
 * COPY. The source of truth is cli/lib/local-time.js. Skills are deployed to
 * ~/yos/.claude/skills/ as standalone units and cannot import from the CLI
 * package, so each carries a copy, exactly as RESTART_FLOOR does. Do not edit
 * this in isolation — cli/lib/__tests__/local-time-parity.test.js fails red if
 * this copy drifts from the original.
 */
