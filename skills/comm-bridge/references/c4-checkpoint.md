...
```bash
~/yos/.claude/skills/comm-bridge/scripts/c4-checkpoint.js <command> [options]
```
...
```bash
# Create a checkpoint
~/yos/.claude/skills/comm-bridge/scripts/c4-checkpoint.js create 50 --summary "Synced conversations 1-50"

# List last 3 checkpoints
~/yos/.claude/skills/comm-bridge/scripts/c4-checkpoint.js list --limit 3

# Get the latest checkpoint
~/yos/.claude/skills/comm-bridge/scripts/c4-checkpoint.js latest
```
