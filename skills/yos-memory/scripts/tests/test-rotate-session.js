...
// Dynamic import: set YOS_DIR before loading so shared.js picks up temp dir
process.env.YOS_DIR = TEST_BASE;
...
function runRotate(envOverrides = {}) {
  const env = { ...process.env, YOS_DIR: TEST_BASE, ...envOverrides };
