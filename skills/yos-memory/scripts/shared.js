/**
 * Shared utilities for yos-memory scripts.
 */
...
export const YOS_DIR = process.env.YOS_DIR || path.join(os.homedir(), 'yos');
export const MEMORY_DIR = path.join(YOS_DIR, 'memory');
...
/**
 * Load TZ from ~/yos/.env and return it.
